const DEFAULT_SYNTH = "[FedLearn watcher] Assistant body was not found in local Cursor SQLite for this workspace. " +
    "Only the user prompt is persisted in aiService.generations; enable real paired storage when Cursor exposes it.";
function envSynthEnabled() {
 ...
 */
export function turnsFromAiServiceGenerations(rawJson, options) {
